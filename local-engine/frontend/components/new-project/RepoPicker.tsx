...
import { GitBranch, Lock, Search, KeyRound } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-sm text-zinc-400 mb-6">
        No git Personal Access Token is set, so we can't list your repos yet — set one in{" "}
        <Link href="/dashboard/account" className="text-blue-400 hover:text-blue-300">
          Settings
        </Link>{" "}
        to browse your own (including private) repos. Public repos work fine without one — search below.
      </p>
